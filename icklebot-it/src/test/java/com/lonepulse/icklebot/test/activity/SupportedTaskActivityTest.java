...
/**
 * <p>Unit test for {@link SupportedTaskActivity}.
 * 
 * @category test
 * <br><br>
 * @version 1.1.0
...
public class SupportedTaskActivityTest {
	
	
	/**
	 * <p>The instance of {@link SupportedTaskActivity} background 
	 * and UI task execution is to be tested.
	 */
	private SupportedTaskActivity activity;
	...
	public final void setUp() throws Exception {
		...
		activity = new SupportedTaskActivity();
