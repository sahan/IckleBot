...
/**
 * <p>Unit test for {@link SupportedTaskFragment}.
 * 
 * @category test
 * <br><br>
 * @version 1.1.0
...
public class SupportedTaskFragmentTest {
	
	
	/**
	 * <p>The instance of {@link FragmentActivityTemplate} which takes 
	 * an {@link SupportedTaskFragment} for testing threading.
	 */
	private FragmentActivityTemplate<SupportedTaskFragment> activity;
	...
	public final void setUp() throws Exception {
		...
		activity = new FragmentActivityTemplate<SupportedTaskFragment>(SupportedTaskFragment.class);
	...
	public final void testGenericBGTask() throws Exception {
		...
		assertTrue(activity.fragment.token >= 0.0);
	}
	...
	public final void testGenericUITask() throws Exception {
		...
		String token = ((TextView)activity.fragment.getView().findViewById(R.id.txtToken)).getText().toString();
	...
	public final void testParameterizedBGTask() throws Exception {
		...
		assertTrue(!activity.fragment.alias.equals("Lonepulse"));
	}
	...
	public final void testParameterizedDelayedUITask() throws Exception {
		...
		String alias = ((TextView)activity.fragment.getView().findViewById(R.id.txtAlias)).getText().toString();
