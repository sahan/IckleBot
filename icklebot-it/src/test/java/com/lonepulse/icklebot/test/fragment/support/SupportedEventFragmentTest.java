...
/**
 * <p>Unit test for {@link SupportedEventFragment}.
 * 
 * @category test
 * <br><br>
 * @version 1.1.0
...
public class SupportedEventFragmentTest {
	
	
	/**
	 * <p>The instance of {@link FragmentActivityTemplate} which takes 
	 * an {@link SupportedEventFragment} for testing event linking.
	 */
	private FragmentActivityTemplate<SupportedEventFragment> activity;
	...
	public final void setUp() throws Exception {
		...
		activity = new FragmentActivityTemplate<SupportedEventFragment>(SupportedEventFragment.class);
