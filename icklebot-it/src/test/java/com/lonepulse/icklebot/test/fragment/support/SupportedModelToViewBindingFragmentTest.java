...
/**
 * <p>Unit test for {@link SupportedModelToViewBindingFragment}.
 * 
 * @category test
 * <br><br>
 * @version 1.1.0
...
public class SupportedModelToViewBindingFragmentTest {
	 ...
	 */
	private FragmentActivityTemplate<SupportedModelToViewBindingFragment> activity;
	...
	public final void setUp() throws Exception {
		...
		activity = new FragmentActivityTemplate<SupportedModelToViewBindingFragment>
						(SupportedModelToViewBindingFragment.class);
	...
	public final void testTernaryBinding() throws Exception {
		...
		String text = ((TextView)activity.fragment.getView().findViewById(R.id.online)).getText().toString();
