...
import com.lonepulse.icklebot.test.activity.ModelToViewBindingActivity;
import com.lonepulse.icklebot.test.activity.suppport.ModelToViewBindingFragmentActivity;
import com.xtremelabs.robolectric.RobolectricTestRunner;

/**
 * <p>Unit test for {@link ModelToViewBindingFragmentActivity}.
 * 
 * @category test
 * <br><br>
 * @version 1.1.0
...
public class ModelToViewBindingFragmentActivityTest {
	
	
	/**
	 * <p>The instance of {@link ModelToViewBindingActivity} 
	 * whose binding is to be tested.
	 */
	private ModelToViewBindingFragmentActivity activity;
	...
	public final void setUp() throws Exception {
		...
		activity = new ModelToViewBindingFragmentActivity();
	...
	public final void testElvisBinding() throws Exception {
		...
		String text = ((TextView)activity.findViewById(R.id.inventory)).getText().toString();
	...
	public final void testStringElementBinding() throws Exception {
		...
		String text = ((TextView)activity.findViewById(R.id.location)).getText().toString();
