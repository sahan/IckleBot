...
/**
 * <p>Unit test for {@link SupportedImplicitInjectionFragment}.
 * 
 * @category test
 * <br><br>
 * @version 1.1.0
...
public class SupportedImplicitInjectionFragmentTest {
	 ...
	 */
	private FragmentActivityTemplate<SupportedImplicitInjectionFragment> activity;
	...
	public final void setUp() throws Exception {
		...
		activity = new FragmentActivityTemplate<SupportedImplicitInjectionFragment>
						(SupportedImplicitInjectionFragment.class);
	...
	public final void testIckleServiceNetwork() throws Exception {
		...
		assertNotNull(activity.fragment.networkManager);
	}
