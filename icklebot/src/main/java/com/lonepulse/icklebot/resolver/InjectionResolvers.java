...
/**
 * <p>A repository of {@link InjectionResolvers} for different <i>modes</i> 
...
public enum InjectionResolvers implements InjectionResolver {
	...
	/**
	 * <p>The {@link InjectionResolver} responsible for resolving 
	...
	/**
	 * <p>The instance of {@link InjectionResolver} used to resolve 
	 * the categories specified in {@link InjectionCategory}.</p>
	 * 
	 * @since 1.0.0
	 */
	...
	/**
	 * <p>Delegate method for {@link #injectionResolver#resolve(Field)}.
	 * 
	 * @since 1.0.0
	 */
	@Override
